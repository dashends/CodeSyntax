...
with open("data/CodeBERT_tokenized/python_full.json", 'r') as f:
...
for example in examples:
    ...
    #     head_view(attn, example["python_tokens"])
        # example['attns'] = attn
        ...
        max_attn_data.append({"python_tokens": example["python_tokens"], "tokens": example["tokens"], 
                            "max_attn": max_attn, "id": example["id"]})

        

with open("data/attention/codebert_python_full_attn_sorted.pkl", "wb") as f:
