...
# max_attn_data = []
# with open("data/attention/codebert_java_full_attn_sorted.pkl", "rb") as f:
#     max_attn_data = pickle.load(f)
# with open("data/attention/codebert_java_full_attn_sorted_valid.pkl", "wb") as f:
#     pickle.dump([c for c in max_attn_data if c["id"]>=11009], f)
# with open("data/attention/codebert_java_full_attn_sorted_test.pkl", "wb") as f:
#     pickle.dump([c for c in max_attn_data if c["id"]<11009], f)
...
for metric in ["first", "any", "last"]:
    for partition in ["valid", "test"]:
        with open("data/attention/codebert_java_full_attn_sorted_"+partition+"_common.pkl", "rb") as f:
            max_attn_data = pickle.load(f)
        ...
        with open("data/scores/codebert_java_full_topk_scores_"+partition+"_"+metric+output_file_name+"_common.pkl", "wb") as f:
